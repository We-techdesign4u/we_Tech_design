  ...
  return (
    <div className="bg-[url(/assets/images/bg3.png)] sm:overflow-hidden bg-center bg-cover bg-no-repeat m-0 p-0">
      <div className="flex flex-col-reverse sm:flex-row sm:h-[100vh] w-screen justify-center">
        <div className=" pt-[10dvh] pl-5 pr-5 sm:pl-[20dvh] pb-[3dvh] flex flex-row items-end sm:h-[100vh] box-border ">
          <div className="">
            ...
            >
              <div>
                <p className=" sm:text-[15dvh] text-[10dvh] sm:leading-[15dvh] leading-[10dvh] font-montHair">
                  Welc
                </p>
              </div>
              <div
              ...
              <div>
                <p className=" sm:text-[15dvh] text-[10dvh] leading-[10dvh] sm:leading-[15dvh] font-montHair">
                  me
                </p>
              </div>
            </div>
            <div
              // class="aboutMe"
              className="sm:w-[90dvh] w-full pt-5"
            >
        ...
        <div className="sm:w-[110vh] w-full  relative overflow-clip h-[380px] sm:h-full -mr-[12dvh] ">
          <div className=" sm:-mt-[70px] -mt-14 sm:-ml-10 ml-[50px] overflow-clip -rotate-28 sm:w-[990px] w-full  absolute flex ">
