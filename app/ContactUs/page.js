  ...
  return (
    <div className="w-screen overflow-x-hidden pt-[50px]  bg-LtBackground ">
      <div className=" w-full ">
        {/**Nav */}
        <div className="fixed z-50 w-full px-3 sm:px-[220px]">
          <div
            className="backdrop-blur-[50px] border border-gray-300 rounded-[20px]
                      px-6 py-3 flex flex-col sm:flex-row sm:items-center
                      justify-between"
          >
            ...
            {/* 🔹 Desktop Menu (STATIC) */}
            <div
              className="hidden sm:flex sm:w-[500px] sm:items-center sm:justify-between
            ...
            <AnimatePresence>
              {isOpen && (
                <motion.div
                  ...
                  animate="open"
                  exit="closed"
                  className="sm:hidden overflow-hidden flex flex-col pt-5
        ...
        <div
          id="about"
          className="block sm:px-[150px] justify-items-center py-20"
        >
          <div>
            <Image
          ...
          <div className=" justify-items-center ">
            <p className=" text-center font-bricolage sm:text-[4rem] text-[1.8rem] sm:leading-15 leading-8 sm:pb-5 pb-2 pt-3 font-black">
              Frontend Developer & <br></br>Graphic Designer
            </p>
            <div className="w-full">
              <span className="sm:text-[1.3rem] text-[11px] flex flex-col sm:flex-row items-center font-interV font-bold">
            ...
            <p className=" pt-4  sm:text-[15px] text-[12px] text-center font-interV">
        ...
        {/**Achievement */}
        <div className="bg-[#f0f0f0] w-full justify-items-center sm:px-[220px] py-20">
          ...
          <div className=" w-full gap-y-6 justify-center items-center pt-12 flex flex-col sm:flex-row sm:justify-between">
            ...
            <div className="w-[330px] h-[383px] border-[1px] border-gray-300 bg-white rounded-[35px]">
              ...
              <div className=" px-5 py-4">
                ...
                <p className="text-[14px] font-interV text-gray-500">
                  Constantly exploring new technologies to stay at the forefront
                  of web development.
                </p>
              </div>
            </div>
        ...
        <div
          id="stack"
          className="bg-[LtBackground] w-full justify-items-center sm:px-[220px] py-20"
        >
          <div className="text-center">
            <p className="font-bricolage pb-3 font-bold text-[1.8rem]">
              My Stack ...
        ...
        <div
          id="projects"
          className="bg-[#f0f0f0] w-full justify-items-center px-5 sm:px-[160px] py-20"
        >
          <div className="text-center">
            <p className="font-bricolage pb-3 font-bold text-[1.8rem]">
              Featured Projects ...
          ...
          <div className=" w-full gap-y-6 justify-center items-center pt-22 flex flex-col sm:flex-row sm:justify-between">
            <div className="sm:w-[375px] w-full sm:-rotate-6 h-[443px] relative bg-white border-[1px] border-gray-300 rounded-[35px]">
              ...
              <div className=" px-5 absolute bottom-0 z-10 py-4">
                <p className="text-[17px] font-interV text-gray-400 font-bold">
                  01
                  <span className="pl-2 text-gray-700">Ecoomerce Website</span>
                </p>
                <p className="text-[14px] font-interV text-gray-500">
            ...
            <div className="sm:w-[375px] w-full sm:-mt-12 h-[443px] relative bg-white border-[1px] border-gray-300 rounded-[35px]">
        ...
        <div
          id="getintouch"
          className="bg-LtBackground w-full justify-items-center px-5 sm:px-[220px] pt-20 sm:py-20"
        >
          <div className="text-center">
            <p className="font-bricolage pb-3 font-bold text-[1.8rem]">
              Get In Touch ...
          ...
          <div className="w-full pt-10 sm:flex-row flex-col-reverse  flex">
            <div className="sm:w-[50%] w-full pt-20 flex items-center">
              <div className="">
                ...
                <form action={formAction} className="p-[20px]">
                  ...
                  <div className="px-5">
                    <p className="text-[14px] font-interV text-gray-600">
                      By clicking on submit, you aggree to send a message to the
        ...
        {/**old */}
        <div className="w-screen sm:px-20 px-5 py-7 flex sm:flex-row flex-col bg-[#ebebeb] items-center justify-between">
          <p className="font-interV">
            © 2025 We-Tech.Design All rights reserved
          </p>
          <p className="font-bricolage py-7 sm:py-0 font-black text-[20px]">
            WE-Tech.Design
          </p>
